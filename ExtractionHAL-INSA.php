...
if (isset($_POST["soumis"])) {
  ...
  include "ExtractionHAL-auteurs-INSA.php";
  $listenominit = "~";
  $listenomcomp1 = "~";
  $listenomcomp2 = "~";
...
<form method="POST" accept-charset="utf-8" name="extrhal" action="ExtractionHAL-INSA.php#sommaire">
...
<td><select size="5" name="autr[]" multiple>
...
if (isset($_POST["soumis"]) || isset($_GET["team"])) {
  ...
  echo("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
  echo("<a href='ExtractionHAL-INSA.php'>Réinitialiser tous les paramètres</a>");
  echo("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
...
function getReferences($infoArray,$sortArray,$docType,$collCode_s,$specificRequestCode,$countries,$institut,$typnum,$typaut,$typnom,$typcol,$typlim,$limaff,$typtit,$typann,$typchr,$typfor,$typdoi,$typidh,$typreva,$typrevc,$typavsa,$listenominit,$listenomcomp1,$listenomcomp2,$sect,$Fnm,$delim,$rtfArray,$font,$fontlien,$fonth2,$fonth3,$root,$gr,$nbeqp,$nomeqp){
   ...
   foreach($results->response->docs as $entry){
      ...
      //Ce champ n'est pas obligatoire pour les communications et posters > on testera alors avec conferenceEndDateY_i
...
if (isset($choix_publis) && strpos($choix_publis, "-ACL-") !== false) {
  ...
  list($numbers["ACL"],$crores) = displayRefList("ART",$team,"%20AND%20peerReviewing_s:1".$specificRequestCode,$countries,"ACL",$institut,$typnum,$typaut,$typnom,$typcol,$typlim,$limaff,$typtit,$typann,$typchr,$typfor,$typdoi,$typidh,$typreva,$typrevc,$typavsa,$listenominit,$listenomcomp1,$listenomcomp2,$sect,$Fnm,$delim,$rtfArray,$font,$fontlien,$fonth2,$fonth3,$root,$gr,$nbeqp,$nomeqp);
}
if (isset($choix_publis) && strpos($choix_publis, "-ASCL-") !== false) {
  ...
  list($numbers["ASCL"],$crores) = displayRefList("ART",$team,"%20AND%20peerReviewing_s:0".$specificRequestCode,$countries,"ASCL",$institut,$typnum,$typaut,$typnom,$typcol,$typlim,$limaff,$typtit,$typann,$typchr,$typfor,$typdoi,$typidh,$typreva,$typrevc,$typavsa,$listenominit,$listenomcomp1,$listenomcomp2,$sect,$Fnm,$delim,$rtfArray,$font,$fontlien,$fonth2,$fonth3,$root,$gr,$nbeqp,$nomeqp);
}
if (isset($choix_publis) && strpos($choix_publis, "-ARI-") !== false) {
  ...
  list($numbers["ARI"],$crores) = displayRefList("ART",$team,"%20AND%20audience_s:2".$specificRequestCode,$countries,"ARI",$institut,$typnum,$typaut,$typnom,$typcol,$typlim,$limaff,$typtit,$typann,$typchr,$typfor,$typdoi,$typidh,$typreva,$typrevc,$typavsa,$listenominit,$listenomcomp1,$listenomcomp2,$sect,$Fnm,$delim,$rtfArray,$font,$fontlien,$fonth2,$fonth3,$root,$gr,$nbeqp,$nomeqp);
}
...
if (isset($choix_publis) && strpos($choix_publis, "-ASCLRI-") !== false) {
  ...
  list($numbers["ASCLRI"],$crores) = displayRefList("ART",$team,"%20AND%20audience_s:2%20AND%20peerReviewing_s:0".$specificRequestCode,$countries,"ASCLRI",$institut,$typnum,$typaut,$typnom,$typcol,$typlim,$limaff,$typtit,$typann,$typchr,$typfor,$typdoi,$typidh,$typreva,$typrevc,$typavsa,$listenominit,$listenomcomp1,$listenomcomp2,$sect,$Fnm,$delim,$rtfArray,$font,$fontlien,$fonth2,$fonth3,$root,$gr,$nbeqp,$nomeqp);
}
...
if (isset($choix_comm) && strpos($choix_comm, "-CI-") !== false) {
  ...
  list($numbers["CI"],$crores) = displayRefList("COMM",$team,"%20AND%20audience_s:2".$specificRequestCode,$countries,"CI",$institut,$typnum,$typaut,$typnom,$typcol,$typlim,$limaff,$typtit,$typann,$typchr,$typfor,$typdoi,$typidh,$typreva,$typrevc,$typavsa,$listenominit,$listenomcomp1,$listenomcomp2,$sect,$Fnm,$delim,$rtfArray,$font,$fontlien,$fonth2,$fonth3,$root,$gr,$nbeqp,$nomeqp);
}
...
if (isset($choix_comm) && strpos($choix_comm, "-CNONINVSA-") !== false) {
  ...
  list($numbers["CNONINVSA"],$crores) = displayRefList("COMM",$team,"%20AND%20invitedCommunication_s:0%20AND%20proceedings_s:0".$specificRequestCode,$countries,"CNONINVSA",$institut,$typnum,$typaut,$typnom,$typcol,$typlim,$limaff,$typtit,$typann,$typchr,$typfor,$typdoi,$typidh,$typreva,$typrevc,$typavsa,$listenominit,$listenomcomp1,$listenomcomp2,$sect,$Fnm,$delim,$rtfArray,$font,$fontlien,$fonth2,$fonth3,$root,$gr,$nbeqp,$nomeqp);
}
if (isset($choix_comm) && strpos($choix_comm, "-CINVI-") !== false) {
  ...
  list($numbers["CINVI"],$crores) = displayRefList("COMM",$team,"%20AND%20invitedCommunication_s:1%20AND%20audience_s:2".$specificRequestCode,$countries,"CINVI",$institut,$typnum,$typaut,$typnom,$typcol,$typlim,$limaff,$typtit,$typann,$typchr,$typfor,$typdoi,$typidh,$typreva,$typrevc,$typavsa,$listenominit,$listenomcomp1,$listenomcomp2,$sect,$Fnm,$delim,$rtfArray,$font,$fontlien,$fonth2,$fonth3,$root,$gr,$nbeqp,$nomeqp);
}
if (isset($choix_comm) && strpos($choix_comm, "-CNONINVI-") !== false) {
  ...
  list($numbers["CNONINVI"],$crores) = displayRefList("COMM",$team,"%20AND%20invitedCommunication_s:0%20AND%20audience_s:2".$specificRequestCode,$countries,"CNONINVI",$institut,$typnum,$typaut,$typnom,$typcol,$typlim,$limaff,$typtit,$typann,$typchr,$typfor,$typdoi,$typidh,$typreva,$typrevc,$typavsa,$listenominit,$listenomcomp1,$listenomcomp2,$sect,$Fnm,$delim,$rtfArray,$font,$fontlien,$fonth2,$fonth3,$root,$gr,$nbeqp,$nomeqp);
}
...
if (isset($choix_comm) && strpos($choix_comm, "-CPI-") !== false) {
  ...
  list($numbers["CPI"],$crores) = displayRefList("POSTER",$team,"%20AND%20audience_s:2".$specificRequestCode,$countries,"CPI",$institut,$typnum,$typaut,$typnom,$typcol,$typlim,$limaff,$typtit,$typann,$typchr,$typfor,$typdoi,$typidh,$typreva,$typrevc,$typavsa,$listenominit,$listenomcomp1,$listenomcomp2,$sect,$Fnm,$delim,$rtfArray,$font,$fontlien,$fonth2,$fonth3,$root,$gr,$nbeqp,$nomeqp);
}
...
if (isset($choix_ouvr) && strpos($choix_ouvr, "-OSPI-") !== false) {
  ...
  list($numbers["OSPI"],$crores) = displayRefList("OUV",$team,"%20AND%20audience_s:2".$specificRequestCode,$countries,"OSPI",$institut,$typnum,$typaut,$typnom,$typcol,$typlim,$limaff,$typtit,$typann,$typchr,$typfor,$typdoi,$typidh,$typreva,$typrevc,$typavsa,$listenominit,$listenomcomp1,$listenomcomp2,$sect,$Fnm,$delim,$rtfArray,$font,$fontlien,$fonth2,$fonth3,$root,$gr,$nbeqp,$nomeqp);
}
...
if (isset($choix_ouvr) && strpos($choix_ouvr, "-COS-") !== false) {
  ...
  list($numbers["COS"],$crores) = displayRefList("COUV",$team,"".$specificRequestCode,$countries,"COS",$institut,$typnum,$typaut,$typnom,$typcol,$typlim,$limaff,$typtit,$typann,$typchr,$typfor,$typdoi,$typidh,$typreva,$typrevc,$typavsa,$listenominit,$listenomcomp1,$listenomcomp2,$sect,$Fnm,$delim,$rtfArray,$font,$fontlien,$fonth2,$fonth3,$root,$gr,$nbeqp,$nomeqp);
}
if (isset($choix_ouvr) && strpos($choix_ouvr, "-COSI-") !== false) {
  ...
  list($numbers["COSI"],$crores) = displayRefList("COUV",$team,"%20AND%20audience_s:2".$specificRequestCode,$countries,"COSI",$institut,$typnum,$typaut,$typnom,$typcol,$typlim,$limaff,$typtit,$typann,$typchr,$typfor,$typdoi,$typidh,$typreva,$typrevc,$typavsa,$listenominit,$listenomcomp1,$listenomcomp2,$sect,$Fnm,$delim,$rtfArray,$font,$fontlien,$fonth2,$fonth3,$root,$gr,$nbeqp,$nomeqp);
}
...
if (isset($choix_ouvr) && strpos($choix_ouvr, "-DOS-") !== false) {
  ...
  list($numbers["DOS"],$crores) = displayRefList("DOUV",$team,"".$specificRequestCode,$countries,"DOS",$institut,$typnum,$typaut,$typnom,$typcol,$typlim,$limaff,$typtit,$typann,$typchr,$typfor,$typdoi,$typidh,$typreva,$typrevc,$typavsa,$listenominit,$listenomcomp1,$listenomcomp2,$sect,$Fnm,$delim,$rtfArray,$font,$fontlien,$fonth2,$fonth3,$root,$gr,$nbeqp,$nomeqp);
}
if (isset($choix_ouvr) && strpos($choix_ouvr, "-DOSI-") !== false) {
  ...
  list($numbers["DOSI"],$crores) = displayRefList("DOUV",$team,"%20AND%20audience_s:2".$specificRequestCode,$countries,"DOSI",$institut,$typnum,$typaut,$typnom,$typcol,$typlim,$limaff,$typtit,$typann,$typchr,$typfor,$typdoi,$typidh,$typreva,$typrevc,$typavsa,$listenominit,$listenomcomp1,$listenomcomp2,$sect,$Fnm,$delim,$rtfArray,$font,$fontlien,$fonth2,$fonth3,$root,$gr,$nbeqp,$nomeqp);
...
if (isset($choix_ouvr) && strpos($choix_ouvr, "-OCO-") !== false) {
  ...
  list($numbers["OCO"],$crores) = displayRefList("OUV+COUV",$team,"".$specificRequestCode,$countries,"OCO",$institut,$typnum,$typaut,$typnom,$typcol,$typlim,$limaff,$typtit,$typann,$typchr,$typfor,$typdoi,$typidh,$typreva,$typrevc,$typavsa,$listenominit,$listenomcomp1,$listenomcomp2,$sect,$Fnm,$delim,$rtfArray,$font,$fontlien,$fonth2,$fonth3,$root,$gr,$nbeqp,$nomeqp);
}
if (isset($choix_ouvr) && strpos($choix_ouvr, "-OCOI-") !== false) {
  ...
  list($numbers["OCOI"],$crores) = displayRefList("OUV+COUV",$team,"%20AND%20audience_s:2".$specificRequestCode,$countries,"OCOI",$institut,$typnum,$typaut,$typnom,$typcol,$typlim,$limaff,$typtit,$typann,$typchr,$typfor,$typdoi,$typidh,$typreva,$typrevc,$typavsa,$listenominit,$listenomcomp1,$listenomcomp2,$sect,$Fnm,$delim,$rtfArray,$font,$fontlien,$fonth2,$fonth3,$root,$gr,$nbeqp,$nomeqp);
}
...
if (isset($choix_ouvr) && strpos($choix_ouvr, "-ODO-") !== false) {
  ...
  list($numbers["ODO"],$crores) = displayRefList("OUV+DOUV",$team,"".$specificRequestCode,$countries,"ODO",$institut,$typnum,$typaut,$typnom,$typcol,$typlim,$limaff,$typtit,$typann,$typchr,$typfor,$typdoi,$typidh,$typreva,$typrevc,$typavsa,$listenominit,$listenomcomp1,$listenomcomp2,$sect,$Fnm,$delim,$rtfArray,$font,$fontlien,$fonth2,$fonth3,$root,$gr,$nbeqp,$nomeqp);
}
if (isset($choix_ouvr) && strpos($choix_ouvr, "-ODOI-") !== false) {
  ...
  list($numbers["ODOI"],$crores) = displayRefList("OUV+DOUV",$team,"%20AND%20audience_s:2".$specificRequestCode,$countries,"ODOI",$institut,$typnum,$typaut,$typnom,$typcol,$typlim,$limaff,$typtit,$typann,$typchr,$typfor,$typdoi,$typidh,$typreva,$typrevc,$typavsa,$listenominit,$listenomcomp1,$listenomcomp2,$sect,$Fnm,$delim,$rtfArray,$font,$fontlien,$fonth2,$fonth3,$root,$gr,$nbeqp,$nomeqp);
}
...
if (isset($choix_ouvr) && strpos($choix_ouvr, "-OCDO-") !== false) {
  ...
  list($numbers["OCDO"],$crores) = displayRefList("OUV+COUV+DOUV",$team,"".$specificRequestCode,$countries,"OCDO",$institut,$typnum,$typaut,$typnom,$typcol,$typlim,$limaff,$typtit,$typann,$typchr,$typfor,$typdoi,$typidh,$typreva,$typrevc,$typavsa,$listenominit,$listenomcomp1,$listenomcomp2,$sect,$Fnm,$delim,$rtfArray,$font,$fontlien,$fonth2,$fonth3,$root,$gr,$nbeqp,$nomeqp);
}
if (isset($choix_ouvr) && strpos($choix_ouvr, "-OCDOI-") !== false) {
  ...
  list($numbers["OCDOI"],$crores) = displayRefList("OUV+COUV+DOUV",$team,"%20AND%20audience_s:2".$specificRequestCode,$countries,"OCDOI",$institut,$typnum,$typaut,$typnom,$typcol,$typlim,$limaff,$typtit,$typann,$typchr,$typfor,$typdoi,$typidh,$typreva,$typrevc,$typavsa,$listenominit,$listenomcomp1,$listenomcomp2,$sect,$Fnm,$delim,$rtfArray,$font,$fontlien,$fonth2,$fonth3,$root,$gr,$nbeqp,$nomeqp);
}
